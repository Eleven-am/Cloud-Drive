...
function toggle(e) {
    ...
    if (!check) {
        ...
        var name = e.currentTarget.attributes["data-name"].nodeValue;
...
function recupeur(baseurl, name) {
    ...
    sharelink = baseurl;
    items[0].setAttribute("data-clipboard-text", "https://mydrive.maix.ovh/share.php?url=" + baseurl);
...
document.getElementById('movebutton').addEventListener('click', function () {
    ...
    xhr.onload = function () {
        try {
            ...
            console.warn("Could not move file/folder! : " + this.responseText);
        }
    }
});
